...
export default function MinimalResume({ summary, personalInfo, additionalInfo, visibleAdditionalFields, education, experience, skills, languages, projects, sectionsConfig = [] }) {
    const renderSection = (sectionId) => {
        switch (sectionId) {
            case "summary":
                return summary && (
                    <div key="summary" className="mb-5 text-center px-4">
            ...
            case "projects":
                return projects?.length > 0 && (
                    <div key="projects" className="mb-4 mt-5">
                        <h4 className="text-uppercase mb-4 pb-2 border-bottom" style={{ color: 'var(--theme-text-primary, #333)', borderColor: 'var(--theme-divider, #eee) !important', letterSpacing: '1px' }}>
                            Projects
                        </h4>
                        {projects.map((proj) => (
            ...
            case "education":
                return education?.length > 0 && (
                    <div key="education" className="mb-4 mt-5">
                        <h4 className="text-uppercase mb-4 pb-2 border-bottom" style={{ color: 'var(--theme-text-primary, #333)', borderColor: 'var(--theme-divider, #eee) !important', letterSpacing: '1px' }}>
                            Education
                        </h4>
                        {education.map((edu) => (
            ...
            case "skills":
                return skills?.length > 0 && (
                    <div key="skills" className="mb-4 mt-5">
                        <h4 className="text-uppercase mb-4 pb-2 border-bottom" style={{ color: 'var(--theme-text-primary, #333)', borderColor: 'var(--theme-divider, #eee) !important', letterSpacing: '1px' }}>
                            Skills
                        </h4>
            ...
            case "languages":
                return languages?.length > 0 && (
                    <div key="languages" className="mb-4 mt-5">
                        <h4 className="text-uppercase mb-4 pb-2 border-bottom" style={{ color: 'var(--theme-text-primary, #333)', borderColor: 'var(--theme-divider, #eee) !important', letterSpacing: '1px' }}>
                            Languages
                        </h4>
    ...
    return (
        <div className="resume-a4 p-5" style={{ backgroundColor: 'var(--theme-content-bg, #fff)' }}>
            ...
            {/* Content dynamically rendered based on sections config */}
            <div className="mt-4">
